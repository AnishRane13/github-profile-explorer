    ...
    <aside className="w-full shrink-0 lg:w-72">
      <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-md border border-gh-border bg-gh-bg-tertiary px-4 py-1.5 text-sm font-medium text-gh-text transition-colors hover:bg-gh-border lg:w-auto"
        >
